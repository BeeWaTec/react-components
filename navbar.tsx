import { Disclosure, Menu, MenuButton, MenuItems, Transition } from "@headlessui/react";
              ...
              <div className="relative flex justify-between h-16">
                ...
                <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                  <Link className="flex-shrink-0 flex items-center" href={"/"}>
                    {logo && <Image src={logo} alt="Logo" width={32} height={32} className="object-contain" />}
                    {logoText && typeof logoText !== "string" && (
                      <div className={"ml-5"}>
                        <Image src={logoText} alt="Logo" width={200} height={32} className="object-contain" />
                      </div>
                    )}
                    {logoText && typeof logoText === "string" && (
                      <div className={`ml-5 text-xl font-bold text-gray-900 dark:text-white`}>{logoText}</div>
                    )}
                  </Link>
                  ...
                  {/* Profile dropdown */}
                  {elementsBeforeUser &&
                    elementsBeforeUser.length > 0 &&
                    elementsBeforeUser.map((element, index) => element)}
                  {showUser && (
                    <>
                      {userIsLoading && (
                  ...
                  <>
                    {elementsAfterUser &&
                      elementsAfterUser.length > 0 &&
                      elementsAfterUser.map((element, index) => element)}
                  </>
                  ...
                  {languages && languages.length > 0 && (
                    <div className="ml-6 flex items-center">
                      <Menu as="div" className="relative inline-block text-left">
                        <div>
                          <MenuButton className="flex items-center bg-gray-100 text-gray-400 hover:text-gray-60">
