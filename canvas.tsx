...
import React, { forwardRef, ForwardRefRenderFunction, ReactElement, Ref, RefAttributes, useEffect, useImperativeHandle, useRef, useState } from "react";
import { FaClipboard, FaDownload, FaImage, FaPen, FaSignature, FaTrash } from "react-icons/fa";
import { FaArrowsToDot, FaCropSimple, FaExpand, FaMagnifyingGlassMinus, FaMagnifyingGlassPlus } from "react-icons/fa6";
                    ...
                    >
                        {!drawingMode &&
                            ...
                            >
                                ...
                                >
                                    <img src={Arrow.src} className="h-4 w-4 object-contain" alt="" />
                                </button>
                                ...
                                >
                                    <img src={Check.src} className="h-4 w-4 object-contain" alt="" />
                                </button>
                                ...
                                >
                                    <img src={Deny.src} className="h-4 w-4 object-contain" alt="" />
                                </button>
                                ...
                                >
                                    <img src={QuestionMark.src} className="h-4 w-4 object-contain" alt="" />
                                </button>
                                ...
                                >
                                    <img src={ExclamationMark.src} className="h-4 w-4 object-contain" alt="" />
                                </button>
                            </div>
                        }
                        {drawingMode &&
