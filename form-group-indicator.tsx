...
function FormGroupIndicator(props: FormGroupIndicatorProps) {
    ...
    return (
        <>
            ...
            />
            <div
                data-tooltip-id={status === 'ok' ? `form-group-indicator-ok-${uuid}` : status === 'warning' ? `form-group-indicator-warning-${uuid}` : status === 'error' ? `form-group-indicator-error-${uuid}` : status === 'disabled' ? `form-group-indicator-disabled-${uuid}` : status === 'loading' ? `form-group-indicator-loading-${uuid}` : status === 'neutral' ? `form-group-indicator-neutral-${uuid}` : 'form-group-indicator'}
